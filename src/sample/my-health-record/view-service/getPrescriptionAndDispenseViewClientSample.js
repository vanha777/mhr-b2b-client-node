...
module.exports = function testPrescriptionAndDispenseView(){
	//returns Promise
	return myHealthRecordClient.getView({product,user,organisation}, patient, {view: "pdv", version: "1.0",parameters:{}});
}
